...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Order.create': {
    roles: ['owner', 'hr-manager', 'employee', 'hr-assistant'],
    key: 'order_123',
    tenantPath: [],
    userPath: [],
  },
  'Job.create': { roles: ['owner', 'hr-manager', 'hr-assistant'], key: 'job_456', tenantPath: [], userPath: [] },
  'TimeOff.create': {
...
const tenantRoles: string[] = ['owner', 'hr-manager', 'employee', 'hr-assistant', 'applicant'];
