...
import { getHrAssistantById, updateHrAssistantById } from 'apiSdk/hr-assistants';
...
function HrAssistantEditPage() {
  ...
  const handleSubmit = async (values: HrAssistantInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateHrAssistantById(id, values);
      mutate(updated);
      resetForm();
    ...
    >
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <TextInput
            error={formik.errors.assigned_tasks}
            label={'Assigned Tasks'}
            props={{
              name: 'assigned_tasks',
              placeholder: 'Assigned Tasks',
              value: formik.values?.assigned_tasks,
