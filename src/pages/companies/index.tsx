...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'applicant.count', 'employee.count', 'hr_assistant.count', 'hr_manager.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('employee', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('hr_assistant', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'hr_assistant',
          header: 'Hr Assistant',
          accessorKey: 'hr_assistant',
          cell: ({ row: { original: record } }: any) => record?._count?.hr_assistant,
        }
      : null,
