      ...
      <Box rounded="md">
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
          ...
          <NumberInput
            ...
            formControlProps={{
              id: 'managed_employees',
              isInvalid: !!formik.errors?.managed_employees,
            }}
            name="managed_employees"
            error={formik.errors?.managed_employees}
            value={formik.values?.managed_employees}
            onChange={(valueString, valueNumber) =>
              formik.setFieldValue('managed_employees', Number.isNaN(valueNumber) ? 0 : valueNumber)
            }
          />
